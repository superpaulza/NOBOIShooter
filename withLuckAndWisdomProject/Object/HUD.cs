...
namespace withLuckAndWisdomProject.Object
{
    public class HUD
    {
        ...
        {
            // Draw Score Section.
            spriteBatch.DrawString(_font, "Score", new Vector2(200, 20), Color.Black);
        ...
        public void DrawDistance(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_font, "Distance", new Vector2(600, 20), Color.Black);
        ...
        {
            // Draw Timer.
            spriteBatch.DrawString(_font, "Time", new Vector2(1000, 20), Color.Black);
